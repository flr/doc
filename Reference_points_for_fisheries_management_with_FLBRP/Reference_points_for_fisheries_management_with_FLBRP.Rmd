...
The default reference points include the [virgin](#virgin) stock, the [$MSY$](#msy) levels, the [crash](#crash) exploitation, the approximation of MSY [$F_{0.1}$](#f01), [$F_{max}$](#fmax) and [$SPR_{3O}$] (#spr30).
