...
Below is an example of calcuating the pretty good yield at 95\% of MSY.

```{r}
#source("D:/WUR/Working Groups/2017/FLR/msy.range.R")
...
p+ geom_area(aes(x = ifelse(x>=minrge & x<=maxrge , x, NA),y=y),fill="grey",alpha=0.5)    
