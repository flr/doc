...
We can add economic data to the `FLBRP` object in order to calculate MEY. To do this, three variables are needed, price (at age) in keuro/ton of fish, variable costs in keuro per unit of fishing mortality *F* and fixed costs in keuro per unit of fishing mortality *F*. 
...
brp4Ri@price[] <- c(rep(1.19,3),rep(1.34,2),rep(1.57,5))
brp4Ri@price@units <- "keuro/ton"

# variable costs per F 
brp4Ri@vcost[] <- 62000
brp4Ri@vcost@units <- "keuro/unit F"

# variable costs per F 
brp4Ri@fcost[] <- 25000
brp4Ri@fcost@units <- "keuro/unit F"
...
## Author information
**Katel Hamon** Wageningen UR. Wageningen Economic Research. Alexanderveld 5, The Hague, The Netherlands.
