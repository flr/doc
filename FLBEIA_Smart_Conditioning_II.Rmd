...
<center>
  ![FLBEIAlogo](./images/FLBEIA_logo.png)
</center>
...
dir <- tempdir()
download.file("http://www.flr-project.org/doc/src/", file.path(dir, "flbeia_smart_cond_II.zip"))
...
hke <- create.biol.arrays('./src/flbeia_smart_cond_II/stocks/HKE2017.xlsx', name = 'HKE',
                   ages = 0:15, hist.yrs = 1982:2017 , sim.yrs = 2018:2025, 
                   fbar = c(1,3), mean.yrs = 2015:2017, excel = TRUE)

mon <- create.biol.arrays('./src/flbeia_smart_cond_II/stocks/MON2017.xlsx', name = 'MON',
                          ages = 0:30, hist.yrs = 1980:2017 , sim.yrs = 2018:2025,
                           fbar = c(1,8), mean.yrs = 2015:2017,  excel = TRUE)
ldb <- create.biol.arrays('./src/flbeia_smart_cond_II/stocks/LDB2017.xlsx', name = 'LDB',
                          ages = 0:7, hist.yrs = 1986:2017 , sim.yrs = 2018:2025, 
                          fbar = c(2,4), mean.yrs = 2015:2017, excel = TRUE)

meg <- create.biol.arrays('./src/flbeia_smart_cond_II/stocks/MEG2017.xlsx', name = 'MEG',
...
stk_objs <- c("./src/flbeia_smart_cond_II/stocks/HKE2017.xlsx", "./src/flbeia_smart_cond_II/stocks/LDB2017.xlsx", 
              "./src/flbeia_smart_cond_II/stocks/MEG2017.xlsx", "./src/flbeia_smart_cond_II/stocks/MON2017.xlsx" )
...
fleets <- create.fleets.arrays(stk_objs,                               
                             ...
                             caa_objs_path ='./src/flbeia_smart_cond_II/fleets/',
                             catch_obj     = './src/flbeia_smart_cond_II/fleets/catch.csv',
                             effort_obj    = './src/flbeia_smart_cond_II/fleets/effort.csv',
                             flt_obj = NULL,
...
fleets <- create.fleets.arrays(flt_obj = fleets,
                               ...
                               price_objs_path = './src/flbeia_smart_cond_II/fleets/', 
                               priceOpt = c(HKE = 3, LDB = 4, MEG = 4, MON = 3),
                               paa_flt_mt_correspondences = './src/flbeia_smart_cond_II/fleets/price_correspondences.xlsx',
...
\begin{figure}
  \centering
      \includegraphics[width=16cm]{./images/flbeia_smart_update_II/table_eco.jpg}
...
ecoD <- create.ecoData('./src/flbeia_smart_cond_II/fleets/economic_data.xlsx', fleets,
