...
CHANGE stk0 TO mp AND stk TO om THROUGHOUT (EXCEPT stk0 USED FOR REF POINTS).
...
```{r fig1, fig.cap="Figure 1. Operating model results for applying an ICES MSY-like rule"}
