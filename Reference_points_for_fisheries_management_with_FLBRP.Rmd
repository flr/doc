...
- FLR: [FLCore](http://www.flrproject.org/FLCore/), [ggplotFL](http://www.flrproject.org/ggplotFL/),[FLBRP](http://www.flrproject.org/FLBRP/)
...
install.packages(c("ggplotFL"), repos="http://flrproject.org/R")
install.packages(c("FLBRP"), repos="http://flrproject.org/R")
