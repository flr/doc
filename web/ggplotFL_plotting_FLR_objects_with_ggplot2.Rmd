...
```{r, pfls,  fig.cap="ggplot2 version of the standard plot() for FLStock, as applied to `ple4`"}
plot(ple4)
```
...
```{r, exsim1, fig.cap="Distribution of values of a simulated time series plotted using geom_boxplot()"}
...
```{r, exsim7, fig.cap="Time series with 75% and 90% credibility intervals plotted using geom_ribbon."}
...
```{r, exspa, fig.cap="Spaghetti plot of an stochastic simulation, by calling geom_line on top of the stored ribbon plot."}
...
```{r, exbub, fig.cap="Bubble plot of catch by age in numbners for North Sea plaice."}
