...
- FLR: [FLCore](http://www.flr-project.org/FLCore/), [FLa4a](http://www.flr-project.org/FLa4a/), [ggplotFL](http://www.flr-project.org/ggplotFL/), [FLBRP](http://www.flr-project.org/FLBRP/)
...
to use them to visualize the status of the stock in relation to these points, for example
...
The [FLash package](http://flr-project.org/FLash) contains the current implementation of the forecasting mechanism in *FLR*
