...
This tutorial details methods for reading various formats of data into R for generating object of the [FLStock](http://www.flr-project.org/FLCore/FLStock.html), [FLIndex](http://www.flr-project.org/FLCore/FLStock.html) and [FLFleet](http://www.flr-project.org/FLCore/FLStock.html) classes.
...
The data are now in your R environment, and before creating a **FLQuant** object, you need to make sure it is consistent with the type of object and formatting that is needed to run the [FLQuant](http://www.flr-project.org/FLCore/FLQuant.html) methd. To get information on the structure and format needed type ?FLQuant in your R Console.
