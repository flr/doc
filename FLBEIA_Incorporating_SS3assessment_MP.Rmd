...
- FLR: 
  [FLCore](http://www.flrproject.org/FLCore/) and 
  [FLFleet](http://www.flrproject.org/FLFleet/).
- Stock Synthesis: 
...
dir <- tempdir()
# download.file("http://www.flrproject.org/doc/src/ibPIL.zip", file.path(dir, "ibPIL.zip"))
...
[Using different Assessment models in the Management Procedure of FLBEIA](http://www.flrproject.org/doc/Using_Assessment_models_in_the_MP_FLBEIA.html)).
