...
## ---- plot_norm_params, fig.cap="The marginal distributions of each of the parameters when using a multivariate normal distribution.", echo=FALSE----
par(mfrow=c(3,1))
...
## ---- plot_tri_params, echo=FALSE, fig.cap="The marginal distributions of each of the parameters based on a multivariate triangle distribution."----
par(mfrow=c(3,1))
...
## ---- plot_tri_scatter, echo=FALSE, fig.cap="Scatter plot of the 10000 parameter sets from the multivariate triangle distribution."----
...
## ---- plot_cop_tri_scatter, echo=FALSE, fig.cap="Scatter plot of the 10000 parameter sets based on the archmCopula copula with triangle margins."----
splom(data.frame(t(params(vbCop)@.Data)), par.settings=list(plot.symbol=list(pch=19, cex=0.1, col=1)))

## ---- plot_cop_tri_growth, fig.cap="Growth curves based on the archmCopula copula with triangle margins.", echo=FALSE----
