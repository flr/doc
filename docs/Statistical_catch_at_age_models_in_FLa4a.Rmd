...
library(knitr)
opts_chunk$set(fig.align='center', message=FALSE, warning=FALSE, echo=TRUE, cache=FALSE)
set.seed(1423)
library(captioner)
...
knit_hooks$set(fig.cap = function(before, options, envir) {
  ...
  options$fig.cap <- paste0(fig_nums(name=options$label), ".")
  return(options)
})
...
**Ernesto Jardim**. European Commission Joint Research Centre (JRC), Institute for the Protection and Security of the Citizen (IPSC), Maritime Affairs Unit, Via E. Fermi 2749, 21027 Ispra VA, Italy. <https://ec.europa.eu/jrc/>
