...
* FLR: [FLCore](http://www.flrproject.org/FLCore/), [FLAssess](http://www.flrproject.org/FLAssess/),
       [FLXSA](http://www.flrproject.org/FLXSA/), [ggplotFL](http://www.flrproject.org/ggplotFL/)
* CRAN: [reshape]
You can do so as follows,

```{r echo=TRUE, eval=FALSE}
install.packages(c("FLCore", "FLAssess", "FLXSA"), repos="http://flrproject.org/R")
```
...
## Stock assessment methods within the FLR package structure
  ...
  [Additional tutorials](http://flrproject.org/doc) are available that will introduce you to other parts of the **FLR** toolset.
