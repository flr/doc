...
We make the **fwdControl** object by passing a list for each target. One of the targets is relative, hence all the additional elements.
...
In this example a minimum revenue is set for each fishery. The target quant os _"revenue"_. Revenue is calculated at the **FLFishery** level meaning that only the **FLFishery** needs to be specified in the control object.
