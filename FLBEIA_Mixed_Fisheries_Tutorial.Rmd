...
dir <- tempdir()
download.file("http://www.flr-project.org/doc/src/", file.path(dir, "flbeia_mixed_fisheries.zip"))
unzip(file.path(dir, "flbeia_mixed_fisheries.zip"), exdir=dir)
```

```{r echo=TRUE, eval=TRUE}
load('./src/flbeia_mixed_fisheries/Smart_Cond_II.Rdata')
stknms <- names(biols)
```
