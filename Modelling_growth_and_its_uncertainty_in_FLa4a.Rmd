...
The marginal distributions can be seen in \@ref(fig:plot_norm_params).
...
The shape of the correlation can be seen in \@ref(fig:plot_norm_scatter).
...
Growth curves for the 10000 iterations can be seen in \@ref(fig:plot_mv_growth).
...
The marginal distributions can be seen in \@ref(fig:plot_tri_params) and the shape of the correlation can be seen in \@ref(fig:plot_tri_scatter).
...
```
We can still use `predict()` to see the growth model uncertainty (\@ref(fig:plot_tri_growth)).
...
```
The shape of the correlation changes is shown in \@ref(fig:plot_cop_tri_scatter) and the resulting growth curves in \@ref(fig:plot_cop_tri_growth).
