...
- FLR: [FLCore](http://www.flrproject.org/FLCore/), [FLAssess](http://www.flrproject.org/FLAssess/), 
       [FLash](http://www.flrproject.org/FLash/), [FLBEIA](http://www.flrproject.org/FLBEIA/), 
       [FLFleet](http://www.flrproject.org/FLFleet/), [ggplotFL](http://www.flrproject.org/ggplotFL/)
...
(e.g. FLXSA.control() for XSA assessment).
  ...
  ([link](http://www.flrproject.org/doc/Stock_assessment_using_eXtended_Survivors_Analysis_with_FLXSA.html)) .
