...
```{r fig:ff_biomass, fig.height= 10/2.54, fig.width =  16/2.54, fig.cap = 'Relative Biomass estimated by SPiCT with shortened time series.'}
par(mfrow = c(1,2))
...
```{r fig:ff_f, fig.height= 10/2.54, fig.width =  16/2.54, fig.cap = 'Absolute fishing mortality estimated by SPiCT.'}
par(mfrow = c(1,2))
 plotspict.f(mur_spict, qlegend = FALSE)
 plotspict.ffmsy(mur_spict, qlegend = FALSE)
...
```{r fig:ff_catch, fig.height= 10/2.54, fig.width =  14/2.54, fig.cap = 'Catch estimated by SPiCT using the shortened time series. The horizontal line corresponds with the MSY.'}
 plotspict.catch(mur_spict, qlegend = FALSE)
```
