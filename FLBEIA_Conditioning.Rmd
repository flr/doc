...
- FLR: [FLCore](http://www.flrproject.org/FLCore/), [FLBEIA](http://www.flrproject.org/FLBEIA/),
...
install.packages(c("FLCore", "FLFleets", "FLash", "FLAssess", "FLXSA", "ggplotFL"), repos="http://flrproject.org/R")
...
tdir <- tempdir()
# download.file("http://flrproject.org/doc/src/ConditioningOne.zip",
